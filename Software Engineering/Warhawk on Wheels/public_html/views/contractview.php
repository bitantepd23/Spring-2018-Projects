  ...
  <div class="row">
        <div class="col-sm-6">
                <div class="form-group">
                  <label>Name*</label>
                  <input class="form-control" type="text" name="contract_name" id="contract_name" required/>
                </div>
        ...
        <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="contract_student_id" name="contract_student_id" id="contract_student_id" required/>
                </div>
  ...
  <div class="row">
        <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="contract_campus_address" id="contract_campus_address" required/>
                </div>
        ...
        <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="contract_phone_number" name="contract_phone_number" id="contract_phone_number" required/>
                </div>
  ...
  <div class="row">
        <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="contract_csd_services_coordinator" id="contract_csd_services_coordinator" required/>
                </div>
    ...
    <div class="row">
          <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="checkbox" name="type_equipment" id="type_equipment" value="power">
                      <label>Power Wheelchair</label><br/>
                    <input type="checkbox" name="type_equipment" id="type_equipment" value="manual">
     ...
     <div class="row">
           <div class="col-sm-6">
                   <div class="form-group">
                     <h3>DVR*</h3>
                     <input type="checkbox" name="dvropt" id="dvropt" value="yes">
                       <label>I have and will use DVR this semester.</label><br/>
                      <input type="checkbox" name="dvropt" id="dvropt" value="no">
