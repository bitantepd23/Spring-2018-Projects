...
echo "
  ...
  <div id='profile' class='col-xs-9'>
        ...
        <tr>
          <th>NetID:</th>
            <th>
              <input ng-model='update_netid' type='text' name='update_netid' id='update_netid'/>
            </th>
        </tr>
        <tr>
          <th>Password:</th>
            <th>
              <input ng-model='update_password' type='text' name='update_password' id='update_password'/>
            </th>
          </tr>
        <tr>
					<th>Student Name:</th>
