...
<form action = 'index.php?mode=updaterequest' method = 'post'>
	<b> Ride Name: </b>
		<input type = 'text' name = 'ride' value = '<?php echo $dataList['ride_name']; ?>' />
	<br><br>
	<b> Pick Up Location: </b>
		<?php
			...
			echo '<option name="'.$dataList['pick_up'].'" value = "'.$dataList['pick_up'].'">'.$dataList['pick_up'].'</option>';
	...
	<b> Destination: </b>
		<?php
			...
			echo '<option name="'.$dataList['destination'].'" value = "'.$dataList['destination'].'">'.$dataList['destination'].'</option>';
	...
	<br><br>
	<b> Start Time: </b>
		<input type = text" name = "start" value = '<?php echo $dataList['start_time']; ?>' />
	<br><br>
	...
	<?php
		...
		$daysArray = str_split($dataList['days'], 3);
	...
	?>
        <br><br>
	<p><input type = 'hidden' name = 'ride_id' value = '<?php echo $dataList['ride_id'];?>' /></p>
